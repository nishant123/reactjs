...
const Proposal = () =>
{
    ...
    const getCostingOptionsOnProjectCreate = () =>
    {
        ...
        let tempCostingOption = [{ label: "Default Option" }];
        //we will get variables list on the bases of methodologies
        let tempVariables = [{ name: "var1", type: "text", label: "var1" },
        ...
        {
            x["Variables"] = _.cloneDeep(tempVariables);
        });   
                ...
                <Row>
                  ...
                  <Col xs="1">
                    <FontAwesomeIcon
                      className="align-middle mr-2"
                      icon={
                        !toggle.costingProfiles ? faChevronRight : faChevronDown
                      }
                      fixedWidth
                    />
                  </Col>
